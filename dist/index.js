...
var BlobShaderMaterial = shaderMaterial(
...
var BlobMesh = ({ audioUrl }) => {
  ...
  return /* @__PURE__ */ jsxs(
    "mesh",
    {
      ...
      children: [
        /* @__PURE__ */ jsx(PositionalAudio, { url: audioUrl, distance: 7, loop: true, ref: sound, autoplay: true }),
        /* @__PURE__ */ jsx("icosahedronGeometry", { args: [4, 100] }),
        /* @__PURE__ */ jsx("blobShaderMaterial", { transparent: true })
      ]
    }
  );
};
      ...
      children: /* @__PURE__ */ jsxs(
        Canvas,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx("pointLight", { position: [10, 10, 10] }),
            /* @__PURE__ */ jsx(BlobMesh, { audioUrl }),
